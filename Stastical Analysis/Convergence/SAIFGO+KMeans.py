# ==========================================================
# SAIFGO + K-MEANS + CONVERGENCE CURVE ANALYSIS
# ==========================================================
...
# ==========================================================
file_path = "/Users/souviksarkarjr./Downloads/Experimental/Placement.csv"   # Change
n_clusters = 3
pop_size = 20          
max_iter = 30          
beta = 2               
...
# ==========================================================
# 4. SAIFGO OPTIMIZATION (TRACKING FITNESS)
# ==========================================================
...
fitness_history.append(final_score)  # Append refined score
...
plt.xlabel("Iteration (Including K-Means Refinement)")
plt.ylabel("Best Composite Fitness")
plt.title("SAIFGO + KMeans Convergence Curve (# Dataset)") 
plt.tight_layout()

output_file = "SAIFGO+KMeans_Convergence.jpg" 
plt.savefig(output_file, format="jpg", dpi=300)
plt.close()

print(f"\nConvergence curve saved as: {output_file}")