...
# ==========================================================
# 5. FCM WITH CONVERGENCE TRACKING
# ==========================================================
...
plt.xlabel("Iteration (Including FCM Refinement)")
plt.ylabel("Best Composite Fitness")
plt.title("SAIFGO + FCM Convergence Curve")
plt.tight_layout()

save_path = os.path.join(os.getcwd(), "SAIFGO+FCM_Convergence.jpg")
plt.savefig(save_path, format="jpg", dpi=300)
plt.close()

print(f"\nConvergence curve saved at: {save_path}")